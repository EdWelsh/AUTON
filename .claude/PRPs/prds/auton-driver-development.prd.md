...
| V10 | **Errata join** — *deferred: no document links a device to an erratum* — *planned: [`w13-driver-errata-join`](../plans/w13-driver-errata-join.plan.md)* | A driver for silicon with applicable errata reports them, and applies a mitigation where H6 has one | H4, H6 |
